...
class Game:
    ...
    def start_screen(self):
        ...
        #self.show_text('- Press S to Start', 32, (230, 245, 255), 250, 320)
        #self.show_text('Jogo desenvolvido por Julia Macedo', 18, (230, 245, 255), 250, 570)
        self.show_start_screen(250, 0)
